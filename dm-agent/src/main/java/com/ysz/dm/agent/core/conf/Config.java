...
package com.ysz.dm.agent.core.conf;

import java.util.HashMap;
import java.util.Map;
import com.ysz.dm.agent.core.context.trace.TraceSegment;
import com.ysz.dm.agent.core.logging.core.LogLevel;
import com.ysz.dm.agent.core.logging.core.LogOutput;
import com.ysz.dm.agent.core.logging.core.WriterFactory;
...
public class Config {
    ...
    public static class Logging {
         ...
         *
         * @see com.ysz.dm.agent.core.logging.core.PatternLogger#DEFAULT_CONVERTER_MAP
         */
