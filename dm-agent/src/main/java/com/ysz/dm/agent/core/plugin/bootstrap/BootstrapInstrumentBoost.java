...
package com.ysz.dm.agent.core.plugin.bootstrap;
...
import com.ysz.dm.agent.core.logging.api.ILog;
import com.ysz.dm.agent.core.logging.api.LogManager;
import com.ysz.dm.agent.core.plugin.AbstractClassEnhancePluginDefine;
import com.ysz.dm.agent.core.plugin.ByteBuddyCoreClasses;
import com.ysz.dm.agent.core.plugin.InstrumentDebuggingClass;
import com.ysz.dm.agent.core.plugin.PluginException;
import com.ysz.dm.agent.core.plugin.PluginFinder;
import com.ysz.dm.agent.core.plugin.interceptor.ConstructorInterceptPoint;
import com.ysz.dm.agent.core.plugin.interceptor.InstanceMethodsInterceptPoint;
import com.ysz.dm.agent.core.plugin.interceptor.StaticMethodsInterceptPoint;
import com.ysz.dm.agent.core.plugin.jdk9module.JDK9ModuleExporter;
import com.ysz.dm.agent.core.plugin.loader.AgentClassLoader;
...
public class BootstrapInstrumentBoost {
    ...
    private static final String[] HIGH_PRIORITY_CLASSES = {
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.BootstrapInterRuntimeAssist",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.InstanceMethodsAroundInterceptor",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.InstanceConstructorInterceptor",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.StaticMethodsAroundInterceptor",
        "com.ysz.dm.agent.core.plugin.bootstrap.IBootstrapLog",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.EnhancedInstance",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.OverrideCallable",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.MethodInterceptResult"
    };

    private static String INSTANCE_METHOD_DELEGATE_TEMPLATE = "com.ysz.dm.agent.core.plugin.bootstrap.template.InstanceMethodInterTemplate";
    private static String INSTANCE_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE = "com.ysz.dm.agent.core.plugin.bootstrap.template.InstanceMethodInterWithOverrideArgsTemplate";
    private static String CONSTRUCTOR_DELEGATE_TEMPLATE = "com.ysz.dm.agent.core.plugin.bootstrap.template.ConstructorInterTemplate";
    private static String STATIC_METHOD_DELEGATE_TEMPLATE = "com.ysz.dm.agent.core.plugin.bootstrap.template.StaticMethodInterTemplate";
    private static String STATIC_METHOD_WITH_OVERRIDE_ARGS_DELEGATE_TEMPLATE = "com.ysz.dm.agent.core.plugin.bootstrap.template.StaticMethodInterWithOverrideArgsTemplate";
