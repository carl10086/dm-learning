...
package com.ysz.dm.agent.core.plugin.jdk9module;
...
public class JDK9ModuleExporter {
    ...
    private static final String[] HIGH_PRIORITY_CLASSES = {
        ...
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.ConstructorInter",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.InstMethodsInter",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.InstMethodsInterWithOverrideArgs",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.StaticMethodsInter",
        "com.ysz.dm.agent.core.plugin.interceptor.enhance.StaticMethodsInterWithOverrideArgs",
        };
