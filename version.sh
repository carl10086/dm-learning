...
function upgrade() {
  echo $(python3 -c 'import sys; o = sys.argv[1]; a = sys.argv[2]; a == "patch" and print (o.split(".")[0] + "." + o.split(".")[1] + "." + str(int(o.split(".")[2])+1) ); a == "minor" and print (o.split(".")[0] + "." + str(int(o.split(".")[1])+1) + ".0" ); a == "major" and print (str(int(o.split(".")[0]) + 1) + ".0.0" );' $1 $2)
}
