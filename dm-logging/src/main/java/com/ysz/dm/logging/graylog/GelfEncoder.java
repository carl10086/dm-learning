...
import com.ysz.dm.logging.graylog.mappers.CallerDataFieldMapper;
import com.ysz.dm.logging.graylog.mappers.MarkerFieldMapper;
import com.ysz.dm.logging.graylog.mappers.MdcDataFieldMapper;
import com.ysz.dm.logging.graylog.mappers.RootExceptionDataFieldMapper;
import com.ysz.dm.logging.graylog.mappers.SimpleFieldMapper;
...
public class GelfEncoder extends EncoderBase<ILoggingEvent> {
  ...
  /**
   * If true, caller data (source file-, method-, class name and line) will be sent, too. Default: false.
   */
  ...
  /**
   * If true, a system depended newline separator will be added at the end of each message. Don't use this in
   * conjunction with TCP or UDP appenders, as this is only reasonable for console logging! Default: false.
   */
  ...
  private void addFieldMapperData(
      final ILoggingEvent event, final Map<String, Object> additionalFields,
