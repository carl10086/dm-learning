...
/**
 * Supplier implementation for GELF message IDs as used for UDP chunks. Unfortunately the GELF protocol limits the
 * message id length to 8 bytes thus an UUID cannot be used (16 bytes).
 */
