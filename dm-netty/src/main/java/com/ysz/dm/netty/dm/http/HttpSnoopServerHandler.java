...
import com.ysz.dm.netty.dm.http.rest.RestHandlerDispatcher;
...
public class HttpSnoopServerHandler extends SimpleChannelInboundHandler<Object> {
  ...
  private final RestHandlerDispatcher dispatcher = RestHandlerDispatcher.getInstance();
  ...
  private String mockJsonResp() {
    Map<String, String> data = new HashMap<>();
    data.put("username", "carl");
    data.put("age", "18");
  ...
  private boolean writeResponse(HttpObject currentObj, ChannelHandlerContext ctx) {
    ...
    FullHttpResponse response = new DefaultFullHttpResponse(
        ...
        Unpooled.copiedBuffer(mockJsonResp(), CharsetUtil.UTF_8));
